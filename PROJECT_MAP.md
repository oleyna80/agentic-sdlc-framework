...
pre_closeout_candidate:
  ...
  required_evidence:
    review: docs/reports/reviews/wb-gov-001-commit-work-block-linkage-r3.md
    verification: docs/reports/verification/wb-gov-001-commit-work-block-linkage-r3.md
    drift: docs/reports/drift/wb-gov-001-commit-work-block-linkage-r3.md
...
promoted_candidates:
  - work_block: docs/plans/wb-release-001-closeout-sequencing-reconciliation.md
    ...
    predecessor_effective_work_block: docs/plans/wb-skill-002b-provider-guard-boundaries.md
    candidate_revision: a254f99cff8b3f382134a5153d4d27b5579e9dd6
    evidence_revision: e30234c21d9a1ce62df07b3053249e9439574963
    required_evidence:
...
WB-RELEASE-001 remains the sole canonical `promoted_effective` ledger record. Its
`pre_closeout_candidate` slot is cleared, raw completed history is preserved,
and no successor candidate is promoted. Closeout candidate:
`docs/plans/wb-gov-001-commit-work-block-linkage.md` (WB-GOV-001), awaiting
assurance evidence on the clean H7 successor revision. This release-state
projection makes no
